        ...
        public:
            ...
            protected:
                ...
                virtual void parseAddLight(istream& input) {
                    string lname,parentname;

                    input >> lname >> parentname;
                    AbstractSGNode * abstractNode = dynamic_cast<AbstractSGNode *>(nodes[parentname]);
                    SGNode * childNode = NULL;

                    if ((abstractNode!=NULL) && (lights.find(lname)!=lights.end())) {
                        abstractNode->addLight(lights[lname]);
                    }
